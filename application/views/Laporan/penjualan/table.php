 ...
 $('#filter').click(function(){
   let dataPost = {
    ...
    let dataKirim = JSON.stringify(dataPost);
       $.ajax({
           type: 'POST',
           url: '<?php echo base_url(); ?>Laporan/Laporan/listLaporanPenjualan',
           data: 'data=' + dataKirim,
           success: function(response) {
               $('#data').html(response);
                    $('.print').remove()
                   $('.tools').append('<a href="<?= base_url();?>Laporan/Laporan/listLaporanPenjualanPrint/'+dataPost.awal+'/'+dataPost.akhir+'/'+dataPost.option+'" class="btn btn-default print"  data-tooltip="tooltip" data-placement="top" title="Print Laporan"><i class="fa fa-print"></i></a>')
