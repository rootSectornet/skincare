        ...
        <div class="col-xs-12 col-md-12">
          <div class="box">
            ...
            <?php echo $this->session->flashdata('pesan_eror'); ?>
              <h2>Update Data Pendaftaran <?= $pendaftaran[0]->id_trx_pendaftaran;?>
                  ...
                  <div class="col-md-6 col-md-offset-3">
                    <?= form_open();?>
                      <div class="form-group">
                        ...
                        <input type="text" name="kode" class="form-control" disabled value="<?= $pendaftaran[0]->id_trx_pendaftaran;?>">
                        <input type="hidden" name="id_trx_pendaftaran" class="form-control"  value="<?= $pendaftaran[0]->id_trx_pendaftaran;?>">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="no_rm" id="no_rm" class="form-control" placeholder="NO RM" required value="<?= $pendaftaran[0]->no_rm;?>">
                      </div>
                      <div class="form-group">
                        <label class="control-label">Tgl Lahir : </label>
                        <input type="text" name="tgl_lahir" id="tgl_lahir"  class="form-control" required id="datepicker" value="<?= $pendaftaran[0]->tgl_lahir;?>">
                      </div>
                      <div class="form-group">
                        <label class="control-label">NO Telp : </label>
                        <input type="text" name="no_telp" id="no_tlp"  class="form-control" required placeholder="080xxxx" value="<?= $pendaftaran[0]->no_telp;?>">
                      </div>
                      <div class="form-group">
                        <label class="control-label">Keterangan : </label>
                        <textarea class="form-control" name="keterangan" rows="4"><?= $pendaftaran[0]->keterangan;?></textarea>
                      </div>
                      <div class="form-group">
                        <button type="submit" class="btn btn-info submit" data-toggle="tooltip" data-placement="top" title="Simpan">Update</button>
    ...
    $('#datepicker').datetimepicker({
     ...
     $(document).ready(function(){
        $('#select').selectize({
            ...
            placeholder: "<?= $pendaftaran[0]->nama_pasien;?>",
            options: [],
            create: false,
            render: {
