                  ...
                  <div class="col-md-6 col-md-offset-3">
                    ...
                    <?php foreach ($product as $key => $row): ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_product" class="form-control" required value="<?= $row->nama_product;?>">
                      </div>
                      <div class="form-group">
                        <label class="control-label">Stock Awal : </label>
                        <input type="number" name="qty" class="form-control" required value="<?= $row->qty;?>">
                      </div>
                    <?php endforeach ?>
                      <div class="form-group">
                        <?= BtnSave('Simpan');?>
