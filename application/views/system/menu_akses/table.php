          ...
          <div class="box">
            <div class="box-header"> 
              ...
              <h2>Data Menu Aplikasi
                <a href="<?php echo base_url() ?>sistem/system/add_menu_akses" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Menu"><i class="fa fa-plus"></i> Tambah</a> 
              </h2>
            </div>
            <div class="box-body">
              <div class="row">
...
$(document).ready(function(){
  $('#group').change(function(){
      let id = $(this).val();
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>sistem/system/get_menu_akses',
            data: 'id=' + id,
